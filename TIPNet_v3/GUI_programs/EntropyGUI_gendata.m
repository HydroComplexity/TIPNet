...
% Last Modified by GUIDE v2.5 08-May-2018 14:25:07
...
nSteps = str2num(get(handles.enter_nsteps,'String'));
mi.nSteps = nSteps;
...
save('GUI_programs/Temps/gendata.mat','mi','data','data_orig','varnames','nSteps','-append')
...
mi.nvars = nvars;
mi.nSteps = str2num(get(handles.enter_nsteps,'String'));
...
mi.DataPrep.Z_effect = zeros(1,nvars);
...
% hObject    handle to enter_nsteps (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of enter_nsteps as text
%        str2double(get(hObject,'String')) returns contents of enter_nsteps as a double
