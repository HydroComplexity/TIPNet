...
% Last Modified by GUIDE v2.5 25-Apr-2017 14:54:34
...
set(handles.Enter_lambda,'String',num2str(filter_lambda))
...
function Enter_lambda_Callback(hObject, eventdata, handles)
% hObject    handle to Enter_lambda (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

new_lambda=str2double(get(hObject,'String'));

load('GUI_programs/Temps/selection.mat');

load('GUI_programs/Temps/projectname.mat')
load(fullpathname)
mi.DataPrep.FilterLambda(Selected) = new_lambda;
save(fullpathname,'mi','-append')
...
function Enter_lambda_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Enter_lambda (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
